...
def _get_pairwise_batch_likefism_data(user_input_pos, user_input_neg, num_items, num_idx_pos, num_idx_neg,
                                      item_input_pos, item_input_neg, num_batch, batch_size):
    num_training_instances = len(user_input_pos)
