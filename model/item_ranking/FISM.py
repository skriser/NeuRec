    ...
    def _create_loss(self):
        with tf.name_scope("loss"):
            ...
            if self.ispairwise.lower() == "true":
                ...
                self.loss = learner.pairwise_loss(self.loss_function, self.result) + self.lambda_bilinear * (
    ...
    def train_model(self):
        ...
        for epoch in range(self.num_epochs):
            if self.ispairwise.lower() == "true":
                ...
                user_input, num_idx, item_input, lables = data_gen._get_pointwise_all_likefism_data(self.dataset,
                                                                                                    self.num_negatives)
                ...
                if self.ispairwise.lower() == "true":
                    ...
                    bat_items_pos, bat_items_neg = \
                        data_gen._get_pairwise_batch_likefism_data(user_input, \
                                                                   user_input_neg, self.dataset.num_items, num_idx_pos,
                                                                   num_idx_neg, item_input_pos, \
                    ...
                    bat_users, bat_idx, bat_items, bat_lables = \
                        data_gen._get_pointwise_batch_likefism_data(user_input, self.dataset.num_items,
                                                                    num_idx, item_input, lables, num_batch,
                                                                    self.batch_size)
