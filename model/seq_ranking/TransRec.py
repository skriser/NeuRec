...
class TransRec(AbstractRecommender):
    ...
    def _create_variables(self):
        with tf.name_scope("embedding"):
            ...
            self.item_embeddings_recent = tf.Variable(
                tf.truncated_normal(shape=[self.num_items, self.embedding_size], mean=0.0, stddev=0.01),
        ...
        with tf.name_scope("loss"):
            ...
            if self.ispairwise.lower() == "true":
                ...
                self.loss = learner.pairwise_loss(self.loss_function, self.result) + self.reg_mf * (
                        ...
                        tf.reduce_sum(tf.square(r1)) +
                        tf.reduce_sum(tf.square(q2)) +
    ...
    def train_model(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            if self.ispairwise.lower() == "true":
                ...
                user_input, item_input, item_input_recents, lables = data_gen._get_pointwise_all_firstorder_data(
